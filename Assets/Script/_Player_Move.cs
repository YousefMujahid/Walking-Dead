...
public class _Player_Move : MonoBehaviour
{
    ...
    void movement()
    {
        ...
        var move = Quaternion.Euler(0, Camera.main.transform.eulerAngles.y, 0) * new Vector3(Input.GetAxis("Horizontal"), -0.1f, Input.GetAxis("Vertical")) *player_speed * Time.deltaTime;
